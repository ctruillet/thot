...
public class Thot extends JFrame{ 
	...
	/**
	* Création d'un nouveau dossier où sont stockés les grammaires générées
	*/
	...
	*/
	...
	public void save_GRXML(int i) {
		...
		try{		
			...
			System.out.println("Erreur dans la cr�ation du fichier grxml.");
		}
	}
	
	/**
	 * Genere le fichier csv récapitulatif des mots-balises
	 */
	public void save_CSV() {
		...
		try{	
			...
			csvOutput.close();
				...
				System.out.println("Erreur dans la cr�ation du fichier CSV.");
			}
	}
